                                    ...
                                    <% } %>
                                        ...
                                        <form action="DeleteReservationServlet" method="get">
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="form-group" style="flex: 0 0 200px; align-self: flex-end;">
                                ...
                                <div class="card">
                                                ...
                                                <tr>
                                                    ...
                                                    <td><span class="text-orange"
                                                            style="font-size: 18px; font-weight: 700;">LKR <%=
                                                                String.format("%,.2f", reservation.getTotalBill()) %>
                                                                </span>
                                                    </td>
                                                </tr>
                                            </tbody>
                                    ...
                                    <form action="DeleteReservationServlet" method="post"
                                        ...
                                        <div class="form-actions" style="margin-top: 24px;">
                                            ...
                                            <a href="deleteReservation.jsp" class="btn btn-secondary">Cancel</a>
                                        </div>
                                    </form>
                                </div>
