                                                ...
                                                <table class="data-table">
                                                    ...
                                                    <tbody>
                                                        <% if (allUsers==null || allUsers.isEmpty()) { %>
                                                            <tr>
                                                                <td colspan="8"
                                                                    style="text-align: center; padding: 20px;">No users
                                                                    found</td>
                                                            </tr>
                                                            <% } else { for (model.User u : allUsers) { %>
                                                                <tr>
                                                                    <td>
                                                                        <%= u.getUserId() %>
                                                                    </td>
                                                                    ...
                                                                    <td>
                                                                        <span class="badge <%= "
                                                                            ADMIN".equals(u.getRole()) ? "badge-admin"
                                                                            : "badge-staff" %>">
                                                                            <%= u.getRole() %>
                                                                        </span>
                                                                    </td>
                                                                    ...
                                                                    <td>
                                                                        <% if ("STAFF".equals(u.getRole())) { %>
                                                                            <button class="btn-icon"
                                                                                ...
                                                                                data-fullname="<%= u.getFullName() != null ? service.UserService.escapeJson(u.getFullName()) : "" %>"
                                                                                data-email="<%= u.getEmail() != null ? service.UserService.escapeJson(u.getEmail()) : "" %>"
                                                                                data-phone="<%= u.getPhone() != null ? service.UserService.escapeJson(u.getPhone()) : "" %>"
